      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        <div className="w-full md:w-1/2">
          <label htmlFor="buscador" className="sr-only">
            Buscar por problema o recomendación...
          </label>
          <input id="buscador" type="search" value={search} onChange={e => setSearch(e.target.value)} placeholder="Buscar por problema o recomendación..." className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 bg-white shadow-sm outline-none" />
        </div>
