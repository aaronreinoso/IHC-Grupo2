          ...
          <div className="flex min-w-0 items-center gap-3">
            ...
            {!isCollapsed && (
              <div>
                ...
                <p className="mt-1 whitespace-nowrap text-[11px] uppercase tracking-[0.2em] text-slate-500">
  ...
  {menuLinks.map((link) => (
    ...
    >
      ...
      <div className="relative flex h-screen flex-1 flex-col overflow-hidden bg-gray-50">
        <header className="z-20 flex shrink-0 items-center justify-between gap-3 border-b border-gray-200 bg-white p-4 shadow-sm md:hidden">
          <button
            type="button"
          ...
          <div className="ml-auto flex items-center gap-3 text-right">
            <div>
              ...
              <p className="text-[11px] text-slate-500">
                {profileLoading
                  ? "Cargando perfil..."
                  : userProfile?.nombre || userProfile?.email || "Usuario"}
              </p>
            </div>
