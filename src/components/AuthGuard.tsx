...
export default function AuthGuard() {
  ...
  useEffect(() => {
    ...
    const requestedBypass = searchParams.get('bypassAuth') === '1' || searchParams.get('skipLogin') === '1';
  ...
  return session || bypassActive ? <Outlet context={{ userProfile, profileLoading } satisfies OutletContext} /> : <Navigate to="/login" replace />;
}